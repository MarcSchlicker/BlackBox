...
public class BlackboxModVariables {
	...
	public static void init(FMLCommonSetupEvent event) {
		BlackboxMod.addNetworkMessage(SavedDataSyncMessage.TYPE, SavedDataSyncMessage.STREAM_CODEC, SavedDataSyncMessage::handleData);
	...
	public record SavedDataSyncMessage(int dataType, SavedData data) implements CustomPacketPayload {
		public static final Type<SavedDataSyncMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(BlackboxMod.MODID, "saved_data_sync"));
	...
	public static class PlayerVariables implements INBTSerializable<CompoundTag> {
		...
		public CompoundTag serializeNBT(HolderLookup.Provider lookupProvider) {
			...
			nbt.putDouble("OverworldPositionx", OverworldPositionx);
			nbt.putDouble("OverworldPositiony", OverworldPositiony);
			nbt.putDouble("OverworldPositionz", OverworldPositionz);
			nbt.putDouble("FarmCounter", FarmCounter);
		...
		public void deserializeNBT(HolderLookup.Provider lookupProvider, CompoundTag nbt) {
			OverworldPositionx = nbt.getDouble("OverworldPositionx");
			OverworldPositiony = nbt.getDouble("OverworldPositiony");
			OverworldPositionz = nbt.getDouble("OverworldPositionz");
			FarmCounter = nbt.getDouble("FarmCounter");
	...
	public record PlayerVariablesSyncMessage(PlayerVariables data) implements CustomPacketPayload {
		public static final Type<PlayerVariablesSyncMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(BlackboxMod.MODID, "player_variables_sync"));
